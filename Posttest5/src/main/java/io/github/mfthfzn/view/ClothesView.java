...
public class ClothesView {
  ...
  private final ClothesServiceImpl clothesServiceImpl;

  private final ScannerUtil scannerUtil;

  public ClothesView(ClothesServiceImpl clothesServiceImpl, ScannerUtil scannerUtil) {
    this.clothesServiceImpl = clothesServiceImpl;
  ...
  protected void showClothesView() {
    ...
    clothesServiceImpl.showProducts();
  }
  ...
  protected void deleteClothesView() {
    ...
    if (inputIndex.equals("x")) {
      ...
      try {
        int index = Integer.parseInt(inputIndex) - 1;
        clothesServiceImpl.checkProduct(index);
        clothesServiceImpl.removeProduct(index);
        System.out.println("==================================================");
